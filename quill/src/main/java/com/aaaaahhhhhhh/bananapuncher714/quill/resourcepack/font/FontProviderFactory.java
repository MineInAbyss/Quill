...
public final class FontProviderFactory {
	...
	private static FontProviderBitmap getProviderBitmap( JsonObject object ) {
		...
		FontProviderBitmap providerBitmap = new FontProviderBitmap( file, arr );
	...
	private static FontProviderTTF getProviderTTF( JsonObject object ) {
		NamespacedKey file = NamespacedKey.fromString( object.get( "file" ).getAsString() );
		...
		FontProviderTTF provider = new FontProviderTTF( file );
	...
	private static FontProviderLegacy getProviderLegacy( JsonObject object ) {
		...
		return new FontProviderLegacy( sizes, template );
	}
}
